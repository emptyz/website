    ...
    echo "<div class='col-md-12'>
          ...
          echo "<div class='col-md-12'>
                  ...
                  <tbody>
                    ...
                    <tr><th scope='row'>Urutan</th>              <td><input type='text' class='form-control' name='urutan' value='$rows[urutan]' required></td></tr>
                    ...
                    <tr><th scope='row'>Status</th>                <td><input type='radio' name='e' value='admin' checked> Admin &nbsp;<input type='radio' name='e' value='operator'> Operator &nbsp; <input type='radio' name='e' value='user'> User</td></tr>
                  </tbody>
                  </table>
                </div>
              </div>
