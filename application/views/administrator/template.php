...
<html>
    <head>
        ...
        <meta name="author" content="ishol.net">
        ...
        <!-- Datetime Picker -->
        <link rel="stylesheet" href="<?php echo base_url(); ?>asset/admin/plugins/datetimepicker/css/bootstrap-datetimepicker.css">
        <!-- Daterange picker -->
    ...
    <body class="hold-transition skin-blue sidebar-mini">
        ...
        <!-- datetimepicker -->
        <script src="<?php echo base_url(); ?>asset/admin/plugins/datetimepicker/js/bootstrap-datetimepicker.js"></script>
