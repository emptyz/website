    ...
    echo "<div class='col-md-12'>
          ...
          echo "<div class='col-md-12'>
                  ...
                  <tbody>
                    ...
                    <tr><th scope='row'>Status Berita</th>               <td><input type='radio' name='is_aktif' value='1'> Publish &nbsp; <input type='radio' name='is_aktif' value='0' checked> Draft</td></tr>
                    <tr><th scope='row'>Privasi Berita</th>               <td><input type='radio' name='is_publik' value='1'> Publik &nbsp; <input type='radio' name='is_publik' value='0' checked> Private</td></tr>
