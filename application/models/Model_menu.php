...
class Model_menu extends CI_model {
    ...
    function menuutama() {
        return $this->db->query("SELECT * FROM mainmenu ORDER BY urutan ASC");
    }
    ...
    function cek_submenu() {
        return $this->db->query("SELECT * FROM submenu");
    }
    ...
    function mainmenu_admin() {
        return $this->db->query("SELECT * FROM mainmenu WHERE aktif = 'N' AND adminmenu= 'Y' ORDER BY urutan ASC");
    }
    ...
    function mainmenu_user() {
        return $this->db->query("SELECT * FROM modul where status='user' and aktif='Y' order by urutan ASC");
    }
